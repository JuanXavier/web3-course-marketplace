			...
			<div className='relative bg-white overflow-hidden'>
				<div className='max-w-7xl mx-auto'>
					<div className='relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32'>
						<svg
							className='hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-white 
						...
						<main className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
							<div className='sm:text-center lg:text-left'>
								{hasOwner && (
									<div className='text-xl inline-block px-4 py-2 rounded-full font-bold bg-green-200 text-green-700'>
										You are owner of:
									</div>
								)}
								...
								<p
									className='mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 
								md:text-xl lg:mx-0'>
									{description}
								</p>
								...
								<div className='mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start'>
									...
									<div className='mt-3 sm:mt-0 sm:ml-3'>
										<a
											href='#'
											className='w-full flex items-center justify-center px-8 py-3 border border-transparent 
											ext-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 
											md:py-4 md:text-lg md:px-10'>
											Watch
										</a>
									</div>
